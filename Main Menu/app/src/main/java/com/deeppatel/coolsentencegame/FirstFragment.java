...
import com.deeppatel.coolsentencegame.databinding.FragmentFirstBinding;
...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonLevel2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(FirstFragment.this)
                        .navigate(R.id.action_FirstFragment_to_LevelSecondFragment);
            }
        });
        ...
        binding.buttonLevel3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(FirstFragment.this)
                        .navigate(R.id.action_FirstFragment_to_LevelThirdFragment);
            }
        });
        ...
        binding.buttonLevel4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(FirstFragment.this)
                        .navigate(R.id.action_FirstFragment_to_LevelFourFragment);
            }
        });
    }
